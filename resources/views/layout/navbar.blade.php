...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NNKF843" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
                    ...
                    <div class="row w-100">
                        <div class="col-lg-7 pr-0">
                            <ul class="nav navbar-nav center_nav pull-right">
                              ...
                              <li class="nav-item @if(request()->path() == 'offer') active @endif"><a class="nav-link" href="{{route('offer')}}">@lang('layout.offer')</a></li>
                              <li class="nav-item @if(request()->path() == 'about') active @endif"><a class="nav-link" href="{{route('about')}}">@lang('layout.about-us')</a></li>
                              <li class="nav-item @if(request()->path() == '/shipping') active @endif"><a class="nav-link" href="{{route('shipping')}}">@lang('layout.shipping')</a></li>
