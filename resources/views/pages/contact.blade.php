                ...
                <div class="col-lg-4">
                    <div class="contact_info">
                        ...
                        <div class="info_item">
                            ...
                            <h6>
                                <a href="mailto:webshop@ukfashionshop.com">webshop@ukfashionshop.com</a>
                            </h6>
                ...
                <div class="col-lg-8">
                    <form class="row contact_form" action="{{route('contact.post')}}" method="post">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="message" id="message" rows="1" placeholder="Enter Message" required>{{old('message' ?? '')}}</textarea>
                            </div>
                        </div>
