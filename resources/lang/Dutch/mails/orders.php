...
return [
    ...
    'bank_transfer_global_trading' => 'Best Sofa',
    ...
    // New Order
    'new_order' => 'New Order in Best Sofa',
    'new_order_first_paragraph' => 'Hello, this email is to inform you that you have new order at Best Sofa',
    ...
    'order_invoice_first_paragraph' => 'Please find the attached invoice file for your order in Best Sofa.',
    'order_invoice_order_id' => 'Order ID',
    'order_invoice_total' => 'Total',

    // Order Receipt
    'order_receipt' => 'Your Order Receipt',
    'order_receipt_first_paragraph' => 'Thank you for your order at Best Sofa, Please find the order information below',
    ...
    'order_receipt_last_paragraph' => 'if you already have an account, you can view your orders from your account page at Best Sofa, Otherwise you can track your order status in the order tracking page.',
